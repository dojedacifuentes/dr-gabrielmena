...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-xl bg-slate-800/60 p-1 text-muted-foreground border border-slate-700/50',
      className
    )}
    {...props}
  />
